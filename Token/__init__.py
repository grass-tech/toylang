...
class Lexer:
    ...
    def _make_include(self, original_pos, match_pos) -> list:
        pos_start = self._pos.copy()
        ...
        self._advanced()
        while True:
            if str(self._current_char) == original_pos:
                include_otherpos = []
                otherpos_idx = 0
                ...
                while True:
                    ...
                    if self._current_char in ("'", '"') and not isString:
                        ...
                        isString = False
                    elif self._current_char == original_pos:
                        include_otherpos.append(True)
                        otherpos_idx += 1
                    if self._current_char == match_pos and not isString and True not in include_otherpos:
                        break
                    elif self._current_char == match_pos and not isString:
                        otherpos_idx -= 1
